    ...
    <div className='border-t-2 pt-10 transition-opacity ease-in duration-500 opacity-100'>
      ...
      <div className='mt-20'>
            ...
            <div className='flex flex-col gap-4 border px-6 py-6 text-sm text-gray-500'>
                      <p>This garment contains recycled polyester, which reuses existing plastic material. This reduces reliance on virgin materials</p>
                      <p>The selection is impressive—there are so many stylish options at affordable prices! I particularly loved the variety of sizes and styles available.</p>
            </div>
      </div>
