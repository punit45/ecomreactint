    ...
    <div className='flex flex-col sm:flex-row justify-between gap-4 pt-5 sm:pt-14 min-h-[80vh] border-t'>
      {/* left part */}
        <div className='flex flex-col gap-4 w-full sm:max-w-[480px]'>
            ...
            <input className='border border-gray-300 rounded py-1.5 px-3.5 w-full' type="email" placeholder='Enter Your E-Mail Address' />
        ...
        {/* right part  */}
        <div className='mt-8'>
            <div className='mt-8 min-v-80'>
                <CartTotal />
            </div>
            <div className='mt-12'>
              <Title text1={'PAYMMENT'} text2={'METHOD'} />
              {/* payment slection */}
